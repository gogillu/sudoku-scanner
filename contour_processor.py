...
class ContourProcessor:
    ...
    def process_image(self, frame):
        ...
        if is_large_contour_present:
            ...
            cv2.imwrite(os.path.join(self.grid_dir, filename), processed_img)
        ...
        #         cv2.imwrite(os.path.join(self.output_dir, os.path.basename(image_path)), cropped)
        #         found = True
        #         break  # Assuming only one big contour is needed
